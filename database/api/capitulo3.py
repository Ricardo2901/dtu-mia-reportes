...
def capitulo3(nombre_proyecto, carpeta_proyecto):
    ...
    descripcionCapitulo31 = di31.add_run(f'El Proyecto "{nombre_proyecto}”, se encuentra ubicado en el ________________________________, cuya superficie para realizar el cambio de uso de suelo es de ____ ha., como se manifiesta en el Anexo mapa No. 3-1. Ubicación del área en estudio.')
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo3.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo3 = doc.add_picture(ruta_imagen, width=Cm(15.59), height=Cm(15.59))
    imagenCapitulo3.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    archivo_docx = os.path.join(
        carpeta_proyecto,
        f"CAPITULO 3 DTU {nombre_proyecto.replace(' ', '_').upper()}.docx"
    )
