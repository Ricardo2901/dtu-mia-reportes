...
def capitulo9(nombre_proyecto, carpeta_proyecto):
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo9', 'capitulo921' , 'cap_921.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo9 = doc.add_picture(ruta_imagen, width=Cm(17.68), height=Cm(3.17))
    ...
    archivo_docx = os.path.join(
        carpeta_proyecto,
        f"CAPITULO 9 DTU {nombre_proyecto.replace(' ', '_').upper()}.docx"
    )
