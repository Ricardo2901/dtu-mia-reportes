...
def capitulo8(nombre_proyecto, carpeta_proyecto):
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo8', 'capitulo81A' , 'cap_81A.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo8 = doc.add_picture(ruta_imagen, width=Cm(5.29), height=Cm(5.27))
    imagenCapitulo8.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo8', 'capitulo81C' , 'formula_1.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo8 = doc.add_picture(ruta_imagen, width=Cm(5.29), height=Cm(1.50))
    imagenCapitulo8.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    # Ahora la usas para agregar la imagen
    imagenCapitulo8 = doc.add_picture(ruta_imagen, width=Cm(3.78), height=Cm(1.50))
    imagenCapitulo8.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    archivo_docx = os.path.join(
        carpeta_proyecto,
        f"CAPITULO 8 DTU {nombre_proyecto.replace(' ', '_').upper()}.docx"
    )
