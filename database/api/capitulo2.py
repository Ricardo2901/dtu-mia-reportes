...
def capitulo2(nombre_proyecto, carpeta_proyecto):
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo2.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo4222 = doc.add_picture(ruta_imagen, width=Cm(17.07), height=Cm(6.56))
    ...
    if nombre_proyecto == 'EXTRACCION DE MATERIAL PETREO':
        encabezados = [
            'Construccion',
            'Operacion',
            'Abandono del sitio',
        ...
        tablaCapitulo2 = doc.add_table(rows=3, cols=len(encabezados), style='Table Grid')

        # Fusionar celdas de la primera fila
        ...
        for i, encabezado in enumerate(encabezados):
            cell = tablaCapitulo2.cell(1, i)
            t21 = cell.paragraphs[0].add_run(encabezado)
            t21.font.name = 'Arial'
            t21.font.size = Pt(12)
            t21.bold = True
            cell.paragraphs[0].alignment = WD_ALIGN_PARAGRAPH.CENTER
            cell_background_color(cell, coloresEncabezados[i])
        ...
        cell = tablaCapitulo2.cell(2, 0)
        t21 = cell.paragraphs[0].add_run('* Construccion de Camino\n'
                                         '* Rampa de Acceso\n'
                                         '* Construccion de Bancos de Extraccion')
        t21.font.name = 'Arial'
        t21.font.size = Pt(12)

        cell = tablaCapitulo2.cell(2, 1)
        t21 = cell.paragraphs[0].add_run('* Barrenadora y voladura\n'
                                         '* Extraccion de material\n'
                                         '* Carga y Accesos')
        t21.font.name = 'Arial'
        t21.font.size = Pt(12)

        cell = tablaCapitulo2.cell(2, 2)
        t21 = cell.paragraphs[0].add_run('* Cierre de todas las instalaciones\n'
                                         '* Reforestacion y Restauracion')
        t21.font.name = 'Arial'
        t21.font.size = Pt(12)

    elif nombre_proyecto == 'FRACCIONAMIENTO CAMPESTRE':
        encabezados = [
            'Construccion',
            'Operacion',
        ]
        ...
        colores3Fila = ['D5F5E3', 'A9CCE3',]  # Colores de la tercera fila
        ...
        for i in range(len(encabezados)):
            cell = tablaCapitulo2.cell(2, i)
            cell.paragraphs[0].alignment = WD_ALIGN_PARAGRAPH.JUSTIFY
            cell_background_color(cell, colores3Fila[i])

        cell = tablaCapitulo2.cell(2, 0)
        t21 = cell.paragraphs[0].add_run('* Delimitacion de lotes\n'
                                        '* Delimitacion de area de cabañas\n'
                                        '* Viabilidad de acceso de cabañas\n'
                                        '* Servicios basicos'
                                        '* Contruccion de Cabañas')
        t21.font.name = 'Arial'
        t21.font.size = Pt(12)

        cell = tablaCapitulo2.cell(2, 1)
        t21 = cell.paragraphs[0].add_run('* Venta de lotes\n'
                                         '* Instalacion\n'
                                         '* Funcionamiento de fraccionamiento campestre')
        t21.font.name = 'Arial'
        t21.font.size = Pt(12)
    
    elif nombre_proyecto == 'FRACCIONAMIENTO URBANO':
        encabezados = [
            'Construccion',
            'Operacion',
        ]
        ...
        cell = tablaCapitulo2.cell(2, 0)
        t21 = cell.paragraphs[0].add_run('* Lotificacion de fraccionamiento\n'
                                        '* Barda perimetral\n'
                                        '* Servicios basicos\n'
        ...
        cell = tablaCapitulo2.cell(2, 1)
        t21 = cell.paragraphs[0].add_run('* Venta de casas (Instalacion del cliente y funcionamiento del fraccionamiento)')
        t21.font.name = 'Arial'
        t21.font.size = Pt(12)

    ### SEGUNDA DESCRIPCINO DEL CAPITULO 2 ###
    dii202 = doc.add_paragraph()
    descripcionCapitulo202 = dii202.add_run(f'\nCon las actividades antes descritas se contempla cubrir todas las necesidades que llevará cada una de las etapas para la implementación en {nombre_proyecto}.')
    ...
    if nombre_proyecto == 'EXTRACCION DE MATERIAL PETREO':
        ...
        listaCapitulo242 = [
            'Delimintacion de lotes',
            'Delimitacion de area de cabañas',
            'Vialidada de Acceso de cabañas',
            'Servicios Basicos',
        ...
        listaCapitulo242 = [
            'Lotificacion de fraccionamiento',
            'Muro perimetral',
            'Servicios basicos',
            'Construccion de Casas'
        ]
    ...
    if nombre_proyecto == 'EXTRACCION DE MATERIAL PETREO':
        ...
        listaCapitulo242 = [
            'Venta de lotes',
            'Instalacion',
            'Funcionamiento de Fraccionamiento',
        ]
        ...
        listaCapitulo242 = [
            'Venta de Casas (Instalacion de Cliente y funcionamiento de fraccionamiento)',
        ]
    ...
    archivo_docx = os.path.join(
        carpeta_proyecto,
        f"CAPITULO 2 DTU {nombre_proyecto.replace(' ', '_').upper()}.docx"
    )
