...
def capitulo10(nombre_proyecto, carpeta_proyecto):
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo10', 'mapa.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo10 = doc.add_picture(ruta_imagen, width=Cm(15.59), height=Cm(10.16))  # Ancho de la imagen en centimetros
    imagenCapitulo10.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo10', 'capitulo10_244' , 'cap_10.244.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo9 = doc.add_picture(ruta_imagen, width=Cm(15.19), height=Cm(13.45))
    imagenCapitulo9.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo10', 'capitulo10_2442', 'imagen1.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo10 = doc.add_picture(ruta_imagen, width=Cm(12.64), height=Cm(7.2))  # Ancho de la imagen en centimetros
    imagenCapitulo10.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo10', 'capitulo10_2442' , 'imagen2.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo10 = doc.add_picture(ruta_imagen, width=Cm(7.34), height=Cm(5.71))
    imagenCapitulo10.alignment = WD_ALIGN_PARAGRAPH.CENTER

    ruta_imagen = os.path.join(BASE_DIR, 'capitulo10', 'capitulo10_2442' , 'imagen3.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo10 = doc.add_picture(ruta_imagen, width=Cm(6.97), height=Cm(5.51))
    imagenCapitulo10.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo10', 'capitulo10_2442' , 'imagen4.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo10 = doc.add_picture(ruta_imagen, width=Cm(13.46), height=Cm(6.32))
    imagenCapitulo10.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo10', 'capitulo10_2442' , 'imagen5.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo10 = doc.add_picture(ruta_imagen, width=Cm(12.72), height=Cm(5.68))
    imagenCapitulo10.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo10', 'capitulo10_2442' , 'imagen6.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo10 = doc.add_picture(ruta_imagen, width=Cm(7.76), height=Cm(6.32))
    imagenCapitulo10.alignment = WD_ALIGN_PARAGRAPH.CENTER

    ruta_imagen = os.path.join(BASE_DIR, 'capitulo10', 'capitulo10_2442' , 'imagen5.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo10 = doc.add_picture(ruta_imagen, width=Cm(6.13), height=Cm(6.64))
    imagenCapitulo10.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo10', 'capitulo10_2442' , 'imagen8.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo10 = doc.add_picture(ruta_imagen, width=Cm(12.72), height=Cm(6.98))
    imagenCapitulo10.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo10', 'capitulo10_2442' , 'imagen9.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo10 = doc.add_picture(ruta_imagen, width=Cm(13.34), height=Cm(6.05))
    imagenCapitulo10.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo10', 'capitulo10_27' , 'formato.png')

    # Ahora la usas para agregar la imagen
    imagenCapitulo10 = doc.add_picture(ruta_imagen, width=Cm(16.17), height=Cm(21.73))
    imagenCapitulo10.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    BASE_DIR = os.path.dirname(__file__)  # directorio donde está capitulo4.py
    ruta_imagen = os.path.join(BASE_DIR, 'capitulo10', 'capitulo10_27' , 'formato.png')
    t10b.add_picture(ruta_imagen, width=Cm(4.3), height=Cm(2.15))
    cell.paragraphs[0].alignment = WD_ALIGN_PARAGRAPH.CENTER
    cell.vertical_alignment = WD_ALIGN_VERTICAL.CENTER
    ...
    archivo_docx = os.path.join(
        carpeta_proyecto,
        f"CAPITULO 10 DTU {nombre_proyecto.replace(' ', '_').upper()}.docx"
    )
