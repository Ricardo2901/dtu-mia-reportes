...
@Component({
  selector: 'app-spradm-proyectos-about-capitulo2',
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './spradm-proyectos-about-capitulo2.component.html',
  styleUrl: './spradm-proyectos-about-capitulo2.component.css'
})
export class SpradmProyectosAboutCapitulo2Component {
